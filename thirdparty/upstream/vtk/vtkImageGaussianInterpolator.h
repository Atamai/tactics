/*=========================================================================
  ...
  Module:    vtkImageGaussianInterpolator.h
...
=========================================================================*/
// .NAME vtkImageGaussianInterpolator - interpolate with Gaussian kernel
// .SECTION Description
// vtkImageGaussianInterpolator performs image interpolation with various
...
#ifndef __vtkImageGaussianInterpolator_h
#define __vtkImageGaussianInterpolator_h
...
class VTK_EXPORT vtkImageGaussianInterpolator :
  public vtkAbstractImageInterpolator
{
public:
  static vtkImageGaussianInterpolator *New();
  vtkTypeMacro(vtkImageGaussianInterpolator, vtkAbstractImageInterpolator);
...
private:
  vtkImageGaussianInterpolator(const vtkImageGaussianInterpolator&);  // Not implemented.
  void operator=(const vtkImageGaussianInterpolator&);  // Not implemented.
};
