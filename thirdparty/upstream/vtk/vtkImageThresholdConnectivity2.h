/*=========================================================================
  ...
  Module:    vtkImageThresholdConnectivity2.h
...
=========================================================================*/
// .NAME vtkImageThresholdConnectivity2 - Flood fill an image region.
// .SECTION Description
// vtkImageThresholdConnectivity2 will perform a flood fill on an image,
...
#ifndef __vtkImageThresholdConnectivity2_h
#define __vtkImageThresholdConnectivity2_h
...
class VTK_IMAGING_EXPORT vtkImageThresholdConnectivity2 :
  public vtkImageAlgorithm
{
public:
  static vtkImageThresholdConnectivity2 *New();
  vtkTypeMacro(vtkImageThresholdConnectivity2, vtkImageAlgorithm);
  ...
  // Description:
  // Hold the results from the previous execution, and add new regions from
  // the new seeds.  If a new seed is located in a region that has already
  // been filled, that seed will be ignored.
  vtkSetMacro(Hold, int);
  vtkGetMacro(Hold, int);
  vtkBooleanMacro(Hold, int);
...
protected:
  vtkImageThresholdConnectivity2();
  ~vtkImageThresholdConnectivity2();
...
private:
  vtkImageThresholdConnectivity2(const vtkImageThresholdConnectivity2&);  // Not implemented.
  void operator=(const vtkImageThresholdConnectivity2&);  // Not implemented.
};
