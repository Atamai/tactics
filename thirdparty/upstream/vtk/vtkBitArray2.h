...
=========================================================================*/
// .NAME vtkBitArray2 - dynamic, self-adjusting array of bits
// .SECTION Description
// vtkBitArray2 is an array of bits (0/1 data value). The array is packed 
// so that each byte stores eight bits. vtkBitArray2 provides methods
// for insertion and retrieval of bits, and will automatically resize 
// itself to hold new data.

#ifndef __vtkBitArray2_h
#define __vtkBitArray2_h

#include "vtkDataArray.h"

class vtkBitArrayLookup;

class VTK_COMMON_EXPORT vtkBitArray2 : public vtkDataArray
{
public:
  static vtkBitArray2 *New();
  vtkTypeMacro(vtkBitArray2,vtkDataArray);
  ...
  // Description:
  // Returns a new vtkBitArray2Iterator instance.
...
protected:
  vtkBitArray2(vtkIdType numComp=1);
  ~vtkBitArray2();
...
private:
  vtkBitArray2(const vtkBitArray2&);  // Not implemented.
  void operator=(const vtkBitArray2&);  // Not implemented.
...
inline void vtkBitArray2::SetNumberOfValues(vtkIdType number) 
{
...
inline void vtkBitArray2::SetValue(vtkIdType id, int value) 
{
  if (value)
    {
...
inline void vtkBitArray2::InsertValue(vtkIdType id, int i)
{
  if ( id >= this->Size )
    {
...
inline void vtkBitArray2::SetVariantValue(vtkIdType id, vtkVariant value)
{
  this->SetValue(id, value.ToInt());
}

inline vtkIdType vtkBitArray2::InsertNextValue(int i)
{
...
inline void vtkBitArray2::Squeeze() {this->ResizeAndExtend (this->MaxId+1);}
