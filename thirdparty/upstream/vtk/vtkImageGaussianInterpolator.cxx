/*=========================================================================
  ...
  Module:    vtkImageGaussianInterpolator.cxx
...
vtkStandardNewMacro(vtkImageGaussianInterpolator);

//----------------------------------------------------------------------------
vtkImageGaussianInterpolator::vtkImageGaussianInterpolator()
{
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::ComputeSupportSize(
...
//----------------------------------------------------------------------------
bool vtkImageGaussianInterpolator::IsSeparable()
{
  return true;
}

//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::SetRadiusFactors(
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::SetKernelType(int ktype)
{
...
//----------------------------------------------------------------------------
const char *vtkImageGaussianInterpolator::GetKernelTypeAsString()
{
  const char *result = "";
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::SetBlurFactors(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::SetAntialiasing(int val)
{
  val = (val != 0);
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::SetRenormalization(int val)
{
  val = (val != 0);
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::InternalDeepCopy(
  vtkAbstractImageInterpolator *a)
{
  vtkImageGaussianInterpolator *obj = vtkImageGaussianInterpolator::SafeDownCast(a);
  if (obj)
    {
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::InternalUpdate()
{
...
template<class F>
void vtkImageGaussianInterpolatorGetInterpolationFunc(
...
template<class F>
void vtkImageGaussianInterpolatorGetRowInterpolationFunc(
...
//----------------------------------------------------------------------------
template<class F>
void vtkImageGaussianInterpolatorPrecomputeWeights(
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::GetInterpolationFunc(
  void (**func)(vtkInterpolationInfo *, const double [3], double *))
{
  vtkImageGaussianInterpolatorGetInterpolationFunc(
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::GetRowInterpolationFunc(
  void (**func)(vtkInterpolationWeights *, int, int, int, double *, int))
{
  vtkImageGaussianInterpolatorGetRowInterpolationFunc(
    func, this->InterpolationInfo->ScalarType, this->KernelType);
}
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::PrecomputeWeightsForExtent(
  ...
  vtkInterpolationWeights *&weights)
{
  ...
  vtkImageGaussianInterpolatorPrecomputeWeights(
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::FreePrecomputedWeights(
  vtkInterpolationWeights *&weights)
{
...
void vtkImageGaussianInterpolator::BuildKernelLookupTable()
{
  if (this->KernelLookupTable[0])
    {
    this->FreeKernelLookupTable();
...
//----------------------------------------------------------------------------
void vtkImageGaussianInterpolator::FreeKernelLookupTable()
{
