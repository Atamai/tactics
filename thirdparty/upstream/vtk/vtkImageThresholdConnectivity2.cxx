/*=========================================================================
  ...
  Module:    vtkImageThresholdConnectivity2.cxx
...
#include "vtkImageThresholdConnectivity2.h"
...
vtkStandardNewMacro(vtkImageThresholdConnectivity2);
vtkCxxSetObjectMacro(vtkImageThresholdConnectivity2, SeedPoints, vtkPoints);

//----------------------------------------------------------------------------
// Constructor sets default values
vtkImageThresholdConnectivity2::vtkImageThresholdConnectivity2()
{
...
//----------------------------------------------------------------------------
void vtkImageThresholdConnectivity2::SetInValue(double val)
{
...
//----------------------------------------------------------------------------
void vtkImageThresholdConnectivity2::SetOutValue(double val)
{
...
void vtkImageThresholdConnectivity2::ThresholdByUpper(double thresh)
{
...
void vtkImageThresholdConnectivity2::ThresholdByLower(
  double thresh)
{
...
void vtkImageThresholdConnectivity2::ThresholdBetween(
...
//----------------------------------------------------------------------------
int vtkImageThresholdConnectivity2::FillInputPortInformation(
...
//----------------------------------------------------------------------------
void vtkImageThresholdConnectivity2::SetStencil(vtkImageStencilData *stencil)
{
  this->SetInput(1, stencil);
}

//----------------------------------------------------------------------------
vtkImageStencilData *vtkImageThresholdConnectivity2::GetStencil()
{
...
//----------------------------------------------------------------------------
unsigned long vtkImageThresholdConnectivity2::GetMTime()
{
...
void vtkImageThresholdConnectivityThresholds(
  vtkImageThresholdConnectivity2 *self,
  ...
  int &voxelCount)
{
  ...
  // Is "hold" set, to hold the results of the last update?
  bool hold = (self->GetHold() != 0);
  ...
  // but only if "Hold" is not "On".  If "Hold" is on, then keep
  // the output from the last update.
  vtkImageIterator<IT> inIt(inData, outExt);
  vtkImageProgressIterator<OT> outIt(outData, outExt, self, id);
  while (!hold && !outIt.IsAtEnd())
    {
  ...
  if (stencil == 0)
    {
    // Don't clear the mask if "hold" is on.
    if (!hold)
      {
...
//----------------------------------------------------------------------------
int vtkImageThresholdConnectivity2::RequestUpdateExtent(
...
//----------------------------------------------------------------------------
int vtkImageThresholdConnectivity2::RequestData(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
...
//----------------------------------------------------------------------------
void vtkImageThresholdConnectivity2::PrintSelf(ostream& os, vtkIndent indent)
{
